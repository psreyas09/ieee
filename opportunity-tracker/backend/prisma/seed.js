...
const societies = [
    ...
    { name: 'Electronics Packaging', web: 'https://ieee-cpmt.org' },
    ...
    { name: 'Industry Applications', web: 'https://ieee-ias.org' },
    ...
    { name: 'Magnetics', web: 'https://ieee-magnetics.org' },
    { name: 'Microwave Theory and Technology', web: 'https://mtt.org' },
    { name: 'Nuclear and Plasma Sciences', web: 'https://ieee-npss.org' },
    { name: 'Oceanic Engineering', web: 'https://ieee-oes.org' },
    { name: 'Photonics', web: 'https://photonics.ieee.org' },
...
const councils = [
    ...
    { name: 'Council on RFID (CRFID)', web: 'https://ieee-crfid.org' },
